...
export function AppProvider({ children }) {
  ...
  const [posts, setPosts] = useState([
    { ID: 1, title: "Student Life", content: "Welcome to ITSTEP Connect" },
    { ID: 2, title: "Project Week", content: "Students are preparing fullstack projects" },
    { ID: 3, title: "React Frontend", content: "Frontend was improved with pages, MUI and Context API" },
  ]);
